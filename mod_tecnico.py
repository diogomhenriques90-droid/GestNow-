...
def render_tecnico(*args):
    ...
    try:
        users_fresh = load_db("usuarios.csv", [
            ...
            "Nome_Emergencia", "Grau_Parentesco", "Banco_IBAN", "Observacoes", "Tamanho_Camisola",
    ...
    if user_data is not None:
        ...
        if precisa_validar:
            ...
            # ✅ CARREGAR PDFs VISTOS DIRETAMENTE DO DATAFRAME FRESCO
            try:
                    ...
                    with st.container():
                        ...
                        if not visto:
                            if st.button(f"✅ Confirmar Visualização: {pdf_nome}", key=f"validar_{pdf_id}", use_container_width=True, type="primary"):
                                ...
                                # ✅ ATUALIZAR O DATAFRAME users_fresh DIRETAMENTE
